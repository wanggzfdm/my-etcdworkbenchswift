        ...
        home: {
            ...
            connector: {
                ...
                form: {
                    ...
                    queryPaginationSize: "Pagination Size",
                    queryPaginationSizeDetail: "Pagination queries the size of each page",
                    queryPaginationDetail: "If this user does not have read permissions for all keys under the namespace, the paginated query function will not be available.",
                    auth: "Auth",
                    ssl: "SSL",
                    ssh: "SSH",
                    ...
                    sslCAType: "Cert Verify",
                    sslCATrustNative: "Trust native roots",
                    sslCASkip: "Skip all roots",
                    sslCACustom: "Customized CA",
                    sslCAFile: "CA File",
