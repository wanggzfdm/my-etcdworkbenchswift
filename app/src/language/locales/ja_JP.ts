        ...
        home: {
            ...
            connector: {
                ...
                form:{
                    ...
                    queryPagination: "ページ番号クエリ",
                    queryPaginationSize: "ページサイズ",
                    queryPaginationSizeDetail: "ページネーションは各ページのサイズを照会します",
                    queryPaginationDetail: "このユーザーが名前空間の下にあるすべてのキーに対する読み取り権限を持っていない場合、ページ分割されたクエリ機能は使用できません。",
                    auth: "認証",
                    ssl: "SSL",
                    ssh: "SSH",
                    authDivider: "認証",
